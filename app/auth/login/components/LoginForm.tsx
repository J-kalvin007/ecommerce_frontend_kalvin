...
export function LoginForm({
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!result.ok) {
      ...
      let finalMessage = "Connexion impossible. Vérifiez vos identifiants.";
      
      if (typeof rawMessage === "string") {
        const lowerMsg = rawMessage.toLowerCase();
        if (lowerMsg.includes("credentials") || lowerMsg.includes("active account") || lowerMsg.includes("no active account") || lowerMsg.includes("mot de passe incorrect")) {
          finalMessage = "Email ou mot de passe incorrect. Veuillez réessayer.";
