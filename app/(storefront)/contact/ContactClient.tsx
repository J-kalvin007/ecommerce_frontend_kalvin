              ...
              >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateField("subject", e.target.value)}
                    required
                    className="w-full cursor-pointer rounded-xl border border-primary/10 bg-white px-4 py-3 text-sm text-slate-900 outline-none focus:border-primary focus:ring-1 focus:ring-primary"
                  >
                    <option value="">Sélectionnez un sujet</option>
                    <option value="order">Ma commande</option>
                    <option value="product">Question produit</option>
                ...
                <button
                  ...
                  disabled={isSending}
                  className={cn(
                    "flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl py-3.5 text-sm font-semibold text-white shadow-lg transition-all",
                    isSending
                      ? "cursor-not-allowed bg-primary/70"
                      : "bg-gradient-to-r from-primary to-primary-hover hover:shadow-glow"
                  )}
            ...
            <div className="mt-6 space-y-3">
              {FAQ.map((item, i) => (
                ...
                >
                  <button
                    onClick={() => setOpenFaq(openFaq === i ? null : i)}
                    className="flex cursor-pointer w-full items-center justify-between px-5 py-4 text-left text-sm font-semibold text-slate-800 transition-colors hover:bg-primary/5"
                  >
                    {item.q}
                    <Clock
                      className={cn(
