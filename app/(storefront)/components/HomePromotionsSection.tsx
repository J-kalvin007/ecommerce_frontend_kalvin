...
import { ArrowRight, Zap } from "lucide-react";
import { PromoProductsCarousel } from "@/app/(storefront)/promotions/components/PromoProductsCarousel";
import { getActiveSales, getActiveRecommendations } from "@/fonctions_api/promotions.api";
import type { Banner, Soldes } from "@/modeles/promotions";

// ---- Interface partagée (à déplacer dans un fichier de types si souhaité) ----
...
// ---- Mapper Soldes → PromoProductCard (identique à celui de PromotionsPage) ----
...
// ---- Composant bannière (utilise désormais Banner) ----
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-sm leading-7 text-gray-600 sm:text-base">
              Des produits du terroir en vente flash, à prix réduits pour une durée limitée.
            </p>
          </div>
