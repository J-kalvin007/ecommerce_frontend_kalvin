...
//                   <Star
//                     key={index}
//                     className={`h-4 w-4 ${index < Math.floor(avgRating)
...
//             fetchedProducts = (data as any).results;
//           }

//           // Tri par order_count décroissant, puis par note_produit décroissante
//           fetchedProducts.sort((a, b) => {
//             const orderDiff = (b.order_count || 0) - (a.order_count || 0);
//             if (orderDiff !== 0) return orderDiff;
//             const ratingA = parseFloat(a.note_produit) || 0;
//             const ratingB = parseFloat(b.note_produit) || 0;
...
//                             key={index}
//                             className={`h-3 w-3 ${
//                               index < Math.floor(avgRating) ? "fill-current" : "text-gray-300"
//                             }`}
//                           />
//                         ))}
