...
//       {/* NOUVELLE SECTION "Une agriculture structurée" sans arrondis */}
//       <section className="hidden">
//         <motion.div
//           variants={fadeUp}
//           initial="hidden"
...
//       {/* Section "Notre processus" (inchangée, mais gardée) */}
//       {/* Section infographie "A propos de nous" */}
...
//                 <Image src={detailImageOne} alt="Production agricole" fill className="object-cover" sizes="432px" />
...
//       {/* Programme de fidélité (inchangé) */}
...
export default function AboutClient() {
  ...
  const heroSrc = popupImage || heroImage;
  const detailSrc = sideBannerImage || detailImageOne;
