...
export function ProductsCatalogClient() {
  ...
  }, [searchQuery, selectedCategory, sortBy, retryTrigger]);
          ...
          <div className="relative max-w-md flex-1">
            ...
            <div className="absolute right-3 top-1/2 -translate-y-1/2">
              ...
              {loading ? (
                ...
                <LoadingKalvin size="sm" message="Chargement des produits..." />
          ...
          <AnimatePresence>
            ...
            {(showFilters || true) && (
              ...
              <motion.aside
                ...
                className={cn(
                  "w-full lg:w-64 shrink-0 space-y-4 transition-all",
          ...
          <div className="flex-1 min-w-0">
            ...
            {loading ? (
              ...
              <motion.div
                ...
                className="flex flex-col items-center justify-center gap-5 rounded-2xl border border-dashed border-[#1f4d3f]/20 bg-[#1f4d3f]/5 py-20 px-4 text-center"
              >
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white shadow-sm border border-[#e7dfd2]">
                  <Leaf className="h-8 w-8 text-[#1f4d3f] opacity-80" />
                </div>
                <div>
                  <h3 className="text-lg font-black tracking-tight text-[#1f241c] mb-1">
                    Oops, un petit souci technique
                  </h3>
                  <p className="text-sm font-medium text-[#8a9086] max-w-sm mx-auto">
                    Nous n'avons pas pu charger les produits pour le moment. Veuillez vérifier votre connexion et réessayer.
                  </p>
                </div>
                <button
                  type="button"
                  onClick={() => setRetryTrigger((prev) => prev + 1)}
                  className="group flex cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-xl bg-gradient-to-r from-[#1f4d3f] to-[#123128] px-6 py-3 text-sm font-bold text-white transition-all hover:shadow-[0_8px_20px_rgba(31,77,63,0.2)] active:scale-[0.98]"
                >
