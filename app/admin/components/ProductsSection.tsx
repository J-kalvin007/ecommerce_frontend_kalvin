            ...
            <table className="w-full">
              ...
              <tbody>
                {filtered.map((product) => (
                  <tr key={product.id} className="border-b border-slate-100 transition-colors hover:bg-slate-50/60">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="relative h-10 w-10 shrink-0 overflow-hidden rounded-lg bg-slate-100 border border-slate-200">
                          {product.image ? (
                            ...
                            <div className="flex h-full w-full items-center justify-center text-xs text-slate-400"><Package className="h-4 w-4" /></div>
                          )}
                        </div>
