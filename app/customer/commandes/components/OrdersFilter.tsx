      ...
      {FILTER_OPTIONS.map(({ value, label }) => {
        ...
        return (
          <motion.button
            ...
            className={`relative flex shrink-0 cursor-pointer items-center gap-1.5 rounded-full px-3.5 py-1.5 text-[14px] font-semibold transition-colors ${isActive
          ...
          >
            ...
            {count > 0 && (
              <span
                className={`flex h-4.5 min-w-[18px] items-center justify-center rounded-full px-1 text-[12px] font-bold ${isActive
