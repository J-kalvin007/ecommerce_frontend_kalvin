...
//  *
//  * Fonctionnalités :
//  * 1. Logo + navigation principale
//  * 2. Barre de recherche avec autocomplétion
//  * 3. Icônes : favoris, Panier (badge quantité), Profil
...
//   const goToDashboard = () => {
//     setIsProfileDropdownOpen(false);
//     const dashboardPath = user?.role === "platform_admin" ? "/admin" : "/dashboard_client";
...
//             ? "bg-transparent"
//             : "border-b border-border/50 bg-white shadow-lg"
//         )}
//       >
...
//                   useTransparentHeader ? "text-white" : "text-[#1f6b3a]"
//                 )}
//               >
//                 Atelier du Terroir
//               </h1>
...
//                     {user?.profile_image ? (
//                       // Utilisation de <img> classique pour éviter l'erreur de domaine externe
//                       <img
...
//       {/* Menu mobile slide-over (inchangé) */}
//       <AnimatePresence>
//         {isMobileMenuOpen && (
//           <>
//             <motion.div
