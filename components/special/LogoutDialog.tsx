            ...
            /> */}
              ...
              <div className="relative z-10 flex flex-col items-center px-8 pb-8 pt-8 text-center">
                ...
                <motion.h2
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${FOREST_DARK} 20%, ${FOREST} 100%, ${GOLD} 80%)`,
                ...
                >
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.97 }}
                    className="flex-1 cursor-pointer rounded-full py-2.5 text-[0.84rem] font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1f4d3f]/20"
                    style={{
                      background: 'rgba(31,77,63,0.04)',
                  ...
                  <motion.button
                    ...
                    className="relative flex-1 cursor-pointer overflow-hidden rounded-full py-2.5 text-[0.84rem] font-bold focus-visible:outline-none focus-visible:ring-2 disabled:opacity-50"
                    style={{
